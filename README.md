## Latihan oop (Object Oriented Programming) pada python
## membuat program crud sederhana dengan mengimplentasikas class pada oop
...
1. Pertama kita buat buat folder `Pertemuan12-oop` dan didalam kita buat file bernama  `Praktikum8.py`.

      ![folder](img/folder.png)


2. Selanjutnya kita akan buat program crud sederhana menggunakan class dan berikut `flowchart` program yang akan dibuat.

      ![flowchart](img/flowchart.png)

      dan berikut class diagram :
...
3. Lalu buka file `Praktikum8.py` dan masukan codingan sebagai berikut lalu run dengan mengetikan perintah berikut diterminal `python Praktikum8.py`:
      ...
      # import tabulate
            ...
            class Mahasiswa:
            def __init__(self):
                  # membuat properti dataMahasiswa
                  self.dataMahasiswa = {
                        'No': [],
                        'Nim': [],
                        'Nama': [],
            ...
            # self merupakan parameter untuk mengakses properti class ,
            def tampilkan(self):
            ...
            def tambah(self, no):
                  # menginput data menggunakan input
            ...
            if tanya == "C":
                  ...
                  print(tabulate(mhs.dataMahasiswa, headers=[
                        'No', 'NIM', 'Nama', 'Tugas', 'UTS', 'UAS', 'Nilai Akhir'], tablefmt="fancy_grid"))
...
### Selesai, Seperti itulah proses penggunaan oop class pada python Mudah mudahan dapat dipahami terima kasih.
